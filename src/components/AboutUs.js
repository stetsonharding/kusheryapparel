    ...
    <div className="about-container wavy-top">
      <div className="about">
        ...
        <p className="lead">
          ...
          to promoting inclusivity and acceptance within the cannabis community,
          and we believe that our clothing can help to break down stereotypes
          and promote positive change. Join us in celebrating the amazing world
          of cannabis with The Kushery.
        </p>
      </div>
    </div>
  );
